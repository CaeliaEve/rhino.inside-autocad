...
/// <summary>
/// Deconstructor component for Civil 3D Alignment Spiral labels.
/// </summary>
[ComponentVersion(introduced: "1.2.19")]
public class CivilAlignmentSpiralLabelComponent : RhinoInsideAutocad_ComponentBase
{
    public override Guid ComponentGuid => new("A7B8C9D0-E1F2-3456-0123-67890ABCDE11");
    protected override System.Drawing.Bitmap Icon => Properties.Resources.CivilDefault;

    public override GH_Exposure Exposure => GH_Exposure.secondary;

    public CivilAlignmentSpiralLabelComponent()
        : base("Civil3d Spiral Label", "CVL-SpiralLbl",
            "Extracts values from an Alignment Spiral Label. Non-matching label types are skipped.",
            "Civil3d", "Labels")
    { }
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
        ...
        if (goo.Value is not AlignmentSpiralLabel labelRaw)
        {
        ...
        var label = new CivilAlignmentSpiralLabelWrapper(labelRaw);
