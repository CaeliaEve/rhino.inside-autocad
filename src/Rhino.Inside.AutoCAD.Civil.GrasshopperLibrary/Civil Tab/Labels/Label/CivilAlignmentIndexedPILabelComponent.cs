...
/// <summary>
/// Deconstructor component for Civil 3D Alignment Indexed PI labels.
/// </summary>
[ComponentVersion(introduced: "1.2.19")]
public class CivilAlignmentIndexedPILabelComponent : RhinoInsideAutocad_ComponentBase
{
    public override Guid ComponentGuid => new("A7B8C9D0-E1F2-3456-0123-67890ABCDE14");
    protected override System.Drawing.Bitmap Icon => Properties.Resources.CivilDefault;

    public override GH_Exposure Exposure => GH_Exposure.secondary;

    public CivilAlignmentIndexedPILabelComponent()
        : base("Civil3d Indexed PI Label", "CVL-IdxPILbl",
            "Extracts values from an Alignment Indexed PI Label. Non-matching label types are skipped.",
            "Civil3d", "Labels")
    { }
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
        ...
        if (goo.Value is not AlignmentIndexedPILabel labelRaw)
        {
        ...
        var label = new CivilAlignmentIndexedPILabelWrapper(labelRaw);
