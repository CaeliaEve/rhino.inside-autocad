...
/// <summary>
/// Deconstructor component for Civil 3D Alignment PI labels.
/// </summary>
[ComponentVersion(introduced: "1.2.19")]
public class CivilAlignmentPILabelComponent : RhinoInsideAutocad_ComponentBase
{
    public override Guid ComponentGuid => new("A7B8C9D0-E1F2-3456-0123-67890ABCDE13");
    protected override System.Drawing.Bitmap Icon => Properties.Resources.CivilDefault;

    public override GH_Exposure Exposure => GH_Exposure.secondary;

    public CivilAlignmentPILabelComponent()
        : base("Civil3d PI Label", "CVL-PILbl",
            "Extracts values from an Alignment PI Label. Non-matching label types are skipped.",
            "Civil3d", "Labels")
    { }
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
        ...
        if (goo.Value is not AlignmentPILabel labelRaw)
        {
        ...
        var label = new CivilAlignmentPILabelWrapper(labelRaw);
