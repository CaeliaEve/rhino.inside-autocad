...
/// <summary>
/// Deconstructor component for Civil 3D Alignment Tangent labels.
/// </summary>
[ComponentVersion(introduced: "1.2.19")]
public class CivilAlignmentTangentLabelComponent : RhinoInsideAutocad_ComponentBase
{
    public override Guid ComponentGuid => new("A7B8C9D0-E1F2-3456-0123-67890ABCDE12");
    protected override System.Drawing.Bitmap Icon => Properties.Resources.CivilDefault;

    public override GH_Exposure Exposure => GH_Exposure.secondary;

    public CivilAlignmentTangentLabelComponent()
        : base("Civil3d Tangent Label", "CVL-TangentLbl",
            "Extracts values from an Alignment Tangent Label. Non-matching label types are skipped.",
            "Civil3d", "Labels")
    { }
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
        ...
        if (goo.Value is not AlignmentTangentLabel labelRaw)
        {
        ...
        var label = new CivilAlignmentTangentLabelWrapper(labelRaw);
