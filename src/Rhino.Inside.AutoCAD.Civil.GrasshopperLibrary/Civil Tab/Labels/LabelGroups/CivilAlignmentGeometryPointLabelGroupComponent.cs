...
/// <summary>
/// Deconstructor component for Civil 3D Alignment Geometry Point Label Groups.
/// </summary>
[ComponentVersion(introduced: "1.2.19")]
public class CivilAlignmentGeometryPointLabelGroupComponent : RhinoInsideAutocad_ComponentBase
{
    public override Guid ComponentGuid => new("A7B8C9D0-E1F2-3456-0123-67890ABCDE22");
    protected override System.Drawing.Bitmap Icon => Properties.Resources.CivilDefault;

    public CivilAlignmentGeometryPointLabelGroupComponent()
        : base("Civil3d Geometry Point Label Group", "CVL-GeoPtLblGrp",
            "Extracts values from an Alignment Geometry Point Label Group. Non-matching types are skipped.",
            "Civil3d", "Labels")
    { }
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
        ...
        if (goo.Value is not CivilAlignmentGeometryPointLabelGroupWrapper labelGroup)
        {
            this.AddRuntimeMessage(GH_RuntimeMessageLevel.Warning,
                $"Skipping non-GeometryPoint label group: {goo.Value.LabelGroupType}");
            return;
        }
