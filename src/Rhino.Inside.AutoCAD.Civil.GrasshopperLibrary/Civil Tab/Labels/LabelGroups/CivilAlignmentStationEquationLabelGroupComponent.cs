...
/// <summary>
/// Deconstructor component for Civil 3D Alignment Station Equation Label Groups.
/// </summary>
[ComponentVersion(introduced: "1.2.19")]
public class CivilAlignmentStationEquationLabelGroupComponent : RhinoInsideAutocad_ComponentBase
{
    public override Guid ComponentGuid => new("A7B8C9D0-E1F2-3456-0123-67890ABCDE23");
    protected override System.Drawing.Bitmap Icon => Properties.Resources.CivilDefault;

    public CivilAlignmentStationEquationLabelGroupComponent()
        : base("Civil3d Station Equation Label Group", "CVL-StaEqLblGrp",
            "Extracts values from an Alignment Station Equation Label Group. Non-matching types are skipped.",
            "Civil3d", "Labels")
    { }
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
        ...
        if (goo.Value is not CivilAlignmentStationEquationLabelGroupWrapper labelGroup)
        {
            this.AddRuntimeMessage(GH_RuntimeMessageLevel.Warning,
                $"Skipping non-StationEquation label group: {goo.Value.LabelGroupType}");
            return;
        }
