...
/// <summary>
/// Deconstructor component for Civil 3D Alignment Cant Label Groups.
/// </summary>
[ComponentVersion(introduced: "1.2.19")]
public class CivilAlignmentCantLabelGroupComponent : RhinoInsideAutocad_ComponentBase
{
    public override Guid ComponentGuid => new("A7B8C9D0-E1F2-3456-0123-67890ABCDE20");
    protected override System.Drawing.Bitmap Icon => Properties.Resources.CivilDefault;

    public CivilAlignmentCantLabelGroupComponent()
        : base("Civil3d Cant Label Group", "CVL-CantLblGrp",
            "Extracts values from an Alignment Cant Label Group. Non-matching types are skipped.",
            "Civil3d", "Labels")
    { }
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
        ...
        if (goo.Value is not CivilAlignmentCantLabelGroupWrapper labelGroup)
        {
            this.AddRuntimeMessage(GH_RuntimeMessageLevel.Warning,
                $"Skipping non-Cant label group: {goo.Value.LabelGroupType}");
            return;
        }
