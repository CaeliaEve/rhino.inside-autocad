...
/// <summary>
/// Deconstructor component for Civil 3D Alignment Superelevation Label Groups.
/// </summary>
[ComponentVersion(introduced: "1.2.19")]
public class CivilAlignmentSuperelevationLabelGroupComponent : RhinoInsideAutocad_ComponentBase
{
    public override Guid ComponentGuid => new("A7B8C9D0-E1F2-3456-0123-67890ABCDE25");
    protected override System.Drawing.Bitmap Icon => Properties.Resources.CivilDefault;

    public CivilAlignmentSuperelevationLabelGroupComponent()
        : base("Civil3d Superelevation Label Group", "CVL-SuperLblGrp",
            "Extracts values from an Alignment Superelevation Label Group. Non-matching types are skipped.",
            "Civil3d", "Labels")
    { }
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
        ...
        if (goo.Value is not CivilAlignmentSuperelevationLabelGroupWrapper labelGroup)
        {
            this.AddRuntimeMessage(GH_RuntimeMessageLevel.Warning,
                $"Skipping non-Superelevation label group: {goo.Value.LabelGroupType}");
            return;
        }
