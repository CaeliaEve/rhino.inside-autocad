...
public interface ICivilProfileEntity
{
    ...
    /// <summary>
    /// Gets the starting point of this entity along the profile in AutoCAD units.
    /// </summary>
    ICivilStationPoint Start { get; }

    /// <summary>
    /// Gets the ending point of this entity along the profile in AutoCAD units.
    /// </summary>
    ...
    /// <summary>
    /// Extracts the geometric representation of this profile entity as a RhinoCurve.
    /// </summary>
    RhinoCurve ToRhinoCurve();
}
