'(C) Copyright 2025 by Autodesk, Inc.
'
'
...
Public Module CodesSpecific
    ...
    Private Function GetCodesFilePathFromIniFile() As String
        ...
        If contentDir <> "" Then
            If (contentDir.LastIndexOf("\", StringComparison.Ordinal) < contentDir.Length - 1) Then
    ...
    Public Sub FillCodeStructure()
        ...
        If Len(Dir(sCodesFilePath)) <> 0 Then
            ...
            While Not parser.EndOfData
                ...
                If currentRow.IndexOf(",", StringComparison.Ordinal) <> -1 Then
                    strIndex = currentRow.Substring(0, currentRow.IndexOf(",", StringComparison.Ordinal))
                    sCodeAndDescription = currentRow.Substring(currentRow.IndexOf(",", StringComparison.Ordinal) + 1)
